...
<script type="text/javascript">
	window.addEvent('domready', function(){
		new Zoo.ApplicationEdit({url: 'index.php?option=com_zoo&controller=new', application_id: '<?php echo $this->application->id; ?>', application_group: '<?php echo $this->application->getGroup();?>'});
