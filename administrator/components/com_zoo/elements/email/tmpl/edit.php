...
<div id="<?php echo $id; ?>">
	...
	<div class="more-options">
		...
		<div class="advanced options">
			<div class="row">
				<label for="elements[<?php echo $element; ?>][<?php echo $index; ?>][text]"><?php echo JText::_('Link Text'); ?></label>
				<?php echo JHTML::_('control.text', 'elements['.$element.']['.$index.'][text]', $text, 'size="60" title="'.JText::_('Link Text').'"'); ?>
			</div>
