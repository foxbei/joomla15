...
<div id="<?php echo $id; ?>">
    ...
    <div class="row">
        <?php echo JHTML::_('control.text', 'elements['.$element.'][url]', $url, 'placeholder="'.JText::_('URL').'" class="url" size="50" maxlength="255" title="'.JText::_('URL').'"'); ?>
    </div>
	...
	<div class="more-options">
		...
		<div class="advanced options">
			<div class="row short">
				<?php echo JHTML::_('control.text', 'elements['.$element.'][width]', $width, 'maxlength="4" title="'.JText::_('Width').'" placeholder="'.JText::_('Width').'"'); ?>
			</div>

			<div class="row short">
					<?php echo JHTML::_('control.text', 'elements['.$element.'][height]', $height, 'maxlength="4" title="'.JText::_('Height').'" placeholder="'.JText::_('Height').'"'); ?>
			</div>
