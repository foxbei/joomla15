	...
	<div class="more-options">
		...
		<div class="advanced options">
			...
			<div class="row short">
				...
				<?php echo JHTML::_('control.text', 'elements['.$element.']['.$index.'][custom_title]', $title, 'size="60" title="'.JText::_('Title').'"'); ?>
			</div>

			<div class="row short">
				<label for="elements[<?php echo $element; ?>][<?php echo $index; ?>][rel]"><?php echo JText::_('Rel'); ?></label>
				<?php echo JHTML::_('control.text', 'elements['.$element.']['.$index.'][rel]', $rel, 'size="60" title="'.JText::_('Rel').'"'); ?>
			</div>
